...
class MarketCapBarChart:
  ...
  private var date: String = TimeConversions.unixTimestampToddMMyyyyWithDash(System.currentTimeMillis())
  ...
  private def bitcoinMarketCap: Long = bitcoinRequest.json.obj("market_data")("market_cap")("usd").num.toLong / 1000000
  private def ethereumMarketCap: Long = ethereumRequest.json.obj("market_data")("market_cap")("usd").num.toLong / 1000000

  private def marketCapPercentage: String = f"${(ethereumMarketCap.toDouble / bitcoinMarketCap.toDouble) * 100}%1.2f"
